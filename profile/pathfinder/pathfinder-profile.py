...
flagHeader = staticInstIndex + "CICC_MODIFY_OPT_MODULE=1 LD_PRELOAD=./libnvcc.so \
    	/usr/local/cuda/bin/nvcc -isystem /usr/include -isystem "+ ROOT_PATH + "/rodinia/common/pathfinder/\
...
optFlags = ""
#############################################################################
makeCommand1 = flagHeader + ROOT_PATH + "/rodinia/cuda/pathfinder/pathfinder.cu -o pathfinder.o" + ktraceFlag
