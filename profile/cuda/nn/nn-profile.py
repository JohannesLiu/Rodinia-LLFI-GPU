...
RODINIA_SOURCE_PATH = ROOT_PATH + "/rodinia/cuda/nn"
DATA_PATH = ROOT_PATH + "/rodinia/data/nn"
PROGRAM_NAME = "nn"
NVCC_DEP_LIST = "/nn.cu"
GEN_OBJECT_LIST = "nn.o"
DATA_LIST = DATA_PATH + "/list640k_64.txt"
#############################################################################
# FI Config
...
############################################################################
bmName = PROGRAM_NAME
inputParameters = DATA_LIST + " -r 3 -lat 30 -lng 90"
#############################################################################
