...
RODINIA_SOURCE_PATH = ROOT_PATH + "/rodinia/cuda/lud"
DATA_PATH = ROOT_PATH + "/rodinia/data/lud"
PROGRAM_NAME = "lud"
DATA_LIST =DATA_PATH + "/2048.dat" # example data: 100, 204800txt, 819200.txt kdd_cup
...
flagHeader = staticInstIndex + "CICC_MODIFY_OPT_MODULE=1 LD_PRELOAD=./libnvcc.so \
    	/usr/local/cuda/bin/nvcc -isystem /usr/include -isystem -Icommon"+ RODINIA_CUDA_LIB_PATH + \
...
optFlags = ""
#############################################################################
makeCommand1 = "cc -O2 -isystem /usr/include -isystem " + RODINIA_CUDA_LIB_PATH + " -c -o " + RODINIA_SOURCE_PATH + "/common/common.o " + RODINIA_SOURCE_PATH + "/common/common.c"
makeCommand2 = flagHeader + RODINIA_SOURCE_PATH + "/lud_kernel.cu" + " -o " + RODINIA_SOURCE_PATH + "/lud_kernel.o" + ktraceFlag
makeCommand3 = flagHeader + RODINIA_SOURCE_PATH + "/lud.cu" + " -o " + RODINIA_SOURCE_PATH + "/lud.o" + ktraceFlag
makeCommand4 = ""
makeCommand5 = ""
...
linkList = " " + PROGRAM_NAME + ".o " + "profiling_runtime.o " + RODINIA_SOURCE_PATH + "/common/common.o " + RODINIA_SOURCE_PATH + "/lud_kernel.o "
