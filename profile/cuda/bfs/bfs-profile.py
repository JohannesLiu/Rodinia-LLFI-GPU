...
RODINIA_SOURCE_PATH = ROOT_PATH + "/rodinia/cuda/bfs"
DATA_PATH = ROOT_PATH + "/rodinia/data/bfs"
PROGRAM_NAME = "bfs"
NVCC_DEP_LIST = "/bfs.cu"
GEN_OBJECT_LIST = "bfs.o"
DATA_LIST = DATA_PATH + "/graph1M.txt"
#############################################################################
# FI Config
