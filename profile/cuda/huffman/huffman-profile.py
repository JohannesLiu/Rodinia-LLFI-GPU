...
RODINIA_SOURCE_PATH = ROOT_PATH + "/rodinia/cuda/huffman"
DATA_PATH = ROOT_PATH + "/rodinia/data/huffman"
PROGRAM_NAME = "pavle"
SOURCE_CODE_LIST = "/pavle.cu"
GEN_OBJECT_LIST = "pavle.o"
DATA_LIST =DATA_PATH + "/test1024_H2.206587175259.in"
...
optFlags = ""
#############################################################################
makeCommand1 = "g++ -O2 -isystem /usr/include -isystem " + RODINIA_CUDA_LIB_PATH + " -c -o " + RODINIA_SOURCE_PATH + "/cpuencode.o " + RODINIA_SOURCE_PATH + "/cpuencode.cpp"
makeCommand2 = flagHeader + RODINIA_SOURCE_PATH + SOURCE_CODE_LIST + " -o " + GEN_OBJECT_LIST + ktraceFlag
...
linkList = " " + PROGRAM_NAME + ".o " + "profiling_runtime.o " + RODINIA_SOURCE_PATH + "/cpuencode.o "
outputExeFile = PROGRAM_NAME+ ".out"
############################################################################
bmName = PROGRAM_NAME
inputParameters = DATA_LIST
#############################################################################
